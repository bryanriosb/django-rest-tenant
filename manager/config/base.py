...
SPECTACULAR_SETTINGS = {
    'TITLE': 'NiiMX Manager API',
    'DESCRIPTION': 'Metaverse and crypto assets management system Documentation',
    'VERSION': '1.0.0',
    'CONTACT': {
        'name': 'NiiMX Development Team',
        'email': 'bryan@lidarit.com',
        'url': 'https://niimx.io'
    },
    ...
    'REDOC_DIST': 'SIDECAR',
    'PREPROCESSING_HOOKS': ['apps.common.openapi.preprocessing_filter_spec']
}
